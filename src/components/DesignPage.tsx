...
function getStepStatuses(hasDesignSystem: boolean, hasShell: boolean): StepStatus[] {
  const statuses: StepStatus[] = []
  statuses.push(hasDesignSystem ? 'completed' : 'current')
  if (hasShell) statuses.push('completed')
  else if (hasDesignSystem) statuses.push('current')
...
export function DesignPage() {
  ...
  const designSystem = landingData.designSystem
  const shell = landingData.shell

  const hasDesignSystem = !!(designSystem?.colors || designSystem?.typography)
  const hasShell = !!shell?.spec
  const allComplete = hasDesignSystem && hasShell

  const stepStatuses = getStepStatuses(hasDesignSystem, hasShell)
      ...
      <div className="space-y-6">
        <div className="mb-8">
          ...
          <p className="text-stone-600 dark:text-stone-400">
            Define the visual foundation and page shell for your landing page.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                ...
                {designSystem?.colors && (
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      <ColorSwatch label="Accent" colorName={designSystem.colors.accent} />
                ...
                {designSystem?.typography && (
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        <p className="text-xs text-stone-500 dark:text-stone-400 mb-1">Display</p>
  ...
  return (
    <div>
      <div className="flex gap-0.5 mb-2">
        <div
          className="flex-1 h-12 rounded-l-md"
        ...
        />
        <div
          className="flex-1 h-12 rounded-r-md"
